...
const UpdateProduct = ({ match, history }) => {
    ...
    //! i do && I must just implement the promoCode box on the cart page
    const [promoCode, setPromoCode] = useState('');
    const [promoCodeValue, setPromoCodeValue] = useState(0);

    let isPromoCode = promoCode.trim() !== '';
                    ...
                    <Fragment>
                        <div className="wrapper my-5">
                            <form className="shadow-lg" onSubmit={submitHandler} encType='multipart/form-data'>
                                ...
                                //! I do
                                <div className="form-group">
                                    <label htmlFor="price_field">Promotion Code</label>
                                    <input
                                        type="text"
                                        id="price_field"
                                        className="form-control"
                                ...
                                {isPromoCode && (
                                    <div className="form-group">
                                        <label htmlFor="price_field">Promotion Code Value(R)</label>
                                        <input
                                            type="text"
                                            id="price_field"
                                            className="form-control"
